...
| POSTGRES_USER | `fieldsets` | *any string* | <ul><li>[fieldsets-local](https://github.com/Fieldsets/fieldsets-local)</li><li>[docker-postgres](https://github.com/Fieldsets/docker-postgres)</li></ul> | PostgreSQL DB username |
...
| **Variable**           | **Default Value** | **Valid Values** | **Projects** | **Description** |
| :--------------------- | :---------------- | :--------------- | :----------- | :-------------- |
| CLICKHOUSE_VERSION     | `25.6`              | *any valid major version number* | none | Clickhouse major release version |
